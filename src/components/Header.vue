  ...
  <header class="fixed w-full backdrop-blur-xl bg-slate-900/70 border-b border-slate-800/40 shadow-lg shadow-black/20 z-1000">
    <nav class="max-w-[1300px] px-[5%] lg:px-0 md:mx-0 lg:mx-auto">
      <div class="h-16 flex items-center justify-between">
        ...
        <!----- BTN GET STARTED ----->
        <button class="hidden md:flex text-white font-semibold bg-linear-to-r from-primary via-accent to-success rounded-lg hover:shadow-lg hover:shadow-primary/30 transition-all duration-300 px-3 py-2 cursor-pointer">
          Get Started
        </button>
        <!----- BTN MOBILE ----->
        <button
          @click="mobileMenuOpen = !mobileMenuOpen"
          class="md:hidden rounded-lg text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300"
        >
      ...
      >
        <div class="flex flex-col gap-2">
          ...
          <button
            class="bg-linear-to-r from-primary to-accent text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-primary/50 transition-all duration-300 mt-2 px-4 py-3"
          >
            Get Started
          </button>
        </div>
